...
| **Email** | Mail, Gmail, Outlook | Formal — proper capitalization, professional structure |
...
Within each mode, you can set a "talking habit" that controls the overall tone:
...
Set your default talking habit in **Settings → AI Formatting**, or customize it per mode.
...
- **Daily limit reached** (for free plans)
...
Set these in **Settings → AI Formatting → Custom Instructions**.
...
Set these in **Settings → AI Formatting → Modes → [Mode] → Custom Instructions**.
