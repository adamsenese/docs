...
Hermes supports 11 types of actions:

| Type | What it does | Complexity |
|------|--------------|------------|
| [Text Expansion](/triggers/types/text-expansion) | Replace phrase with text | Simple |
...
| [Window Actions](/triggers/types/window-actions) | Move/resize windows | Medium |
| [Keyboard Shortcuts](/triggers/types/keyboard-shortcuts) | Simulate key presses | Medium |
| [Siri Shortcuts](/triggers/types/siri-shortcuts) | Run Shortcuts app workflows | Medium |
...
| [Compound Actions](/triggers/types/compound-actions) | Chain multiple actions | Advanced |
