...
Siri Shortcuts runs workflows from Apple's Shortcuts app. If you've built automations in Shortcuts, you can trigger them with Hermes.
...
## Creating a Siri Shortcuts trigger
...
<Steps>
  ...
  <Step title="Select Siri Shortcuts">
    Choose **Siri Shortcuts** as the action type.
  </Step>
