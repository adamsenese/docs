...
Text Expansion replaces your trigger phrase with predefined text. It's the simplest trigger type — say a short phrase, get a longer text.
...
## Creating a text expansion trigger
...
<Steps>
  ...
  <Step title="Select Text Expansion">
    Choose **Text Expansion** as the action type.
  </Step>
...
<CardGroup cols={2}>
  <Card title="Variables" icon="code" href="/triggers/variables">
    Add dynamic content to expansions.
  </Card>
