...
2. Lower the **Voice Activity Threshold** (closer to 0)
3. This makes Hermes more sensitive to quieter speech
...
**Adjust voice activity threshold:**
1. Go to **Settings → Dictation**
2. Raise the **Voice Activity Threshold** (closer to 1)
3. This makes Hermes less sensitive, requiring louder speech
...
1. Go to **Settings → Dictation**
2. Disable **Auto-stop after silence** if you need long pauses
3. Or use **double-tap mode** for hands-free long dictation

**Check max duration:**
1. Go to **Settings → Dictation**
2. Increase **Max Recording Duration** if needed
